...
/**
 * Classe principal para o servidor WebSockets, responsável por subir todas
 * as configurações e armazenar as rotas. Foi retirada do próprio
 * código do Ratchet e modificada.
 */
class App {
    /**
     ...
     */
    public function route($path, $controller, array $allowedOrigins = array(), $httpHost = null) {
        ...
        $this->routes->add('rr-' . ++$this->routeCounter, new Route($path, array('_controller' => $decorated), array('Origin' => $this->httpHost), array(), $httpHost));
